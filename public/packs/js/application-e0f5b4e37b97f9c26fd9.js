...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'datatables.net-dt/css/jquery.dataTables.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'datatables.net-select-dt/css/select.dataTables.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
global.$ = jQuery; // Add DataTables jQuery plugin

__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'imports-loader?define=>false!datatables.net'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()))(window, jquery__WEBPACK_IMPORTED_MODULE_0___default.a);

__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'imports-loader?define=>false!datatables.net-select'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()))(window, jquery__WEBPACK_IMPORTED_MODULE_0___default.a); // Load datatables styles




jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('turbolinks:load', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document.body).on('click', '#check_all', function () {
    var checkBoxes = jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type="checkbox"]');
    checkBoxes.prop("checked", !checkBoxes.prop("checked"));
  }); // placeholder example for datatable with checkboxes

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#example').DataTable({
    columnDefs: [{
      render: function render(data, type, row) {
        return "<input type=\"checkbox\" value=\"".concat(row[0], "\">");
      },
      orderable: false,
      targets: 0
    }],
...
//= require bootstrap.bundle.js.map
//= require bootstrap.bundle.min.js
//= require bootstrap.bundle.min.js.map
//= require bootstrap.js
//= require bootstrap.js.map
//= require bootstrap.min.js
//= require bootstrap.min.js.map
...
//= require dataTables.jqueryui.js
//= require dataTables.jqueryui.min.js
//= require dataTables.semanticui.js
...
/******/ });
//# sourceMappingURL=application-e0f5b4e37b97f9c26fd9.js.map